...
export function SpaceModal({ space, isOpen, onClose, onBookingClick }: SpaceModalProps) {
  ...
  const amenities = [
    {
      ...
      available: space.facilities.wifi,
      description: "100 Mbps fiber connection",
    },
    {
      icon: Car,
      label: "Parking Available",
      available: space.facilities.parking,
      description: "Free parking for 10 cars",
    },
    {
      icon: Users,
      label: `Capacity: ${space.facilities.capacity} people`,
      available: true,
  ...
  const handleBookingSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("[v0] Quick booking submitted:", bookingData)
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-7xl w-[95vw] h-[75vh] overflow-hidden p-0 rounded-2xl border-2 border-border bg-background">
        <Button
          variant="ghost"
          size="sm"
          onClick={onClose}
        ...
        <div className="flex flex-col h-full">
          <div className="relative h-48 w-full flex-shrink-0">
            <div className="w-full h-full relative overflow-hidden rounded-t-2xl">
              {is360View ? (
                <div className="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center">
                  <div className="text-center text-white">
                    <Camera className="w-12 h-12 mx-auto mb-3" />
                    <p className="text-xl font-semibold mb-2">360° Virtual Tour</p>
                    <p className="text-sm opacity-75 mb-2">Interactive 360° view would be implemented here</p>
                    <p className="text-xs opacity-50">Using libraries like panolens.js or react-three-fiber</p>
                  </div>
                </div>
              ) : (
                <img
          ...
          <div className="flex-1 grid grid-cols-1 lg:grid-cols-7 gap-0 overflow-hidden min-h-0">
            {/* Left side - Details and Amenities */}
            <div className="lg:col-span-4 overflow-y-auto p-6 bg-background">
              <DialogHeader className="mb-4">
                <div className="flex items-start justify-between">
                  <div>
                    <DialogTitle className="text-2xl font-bold text-balance mb-2 text-foreground">
                      {space.name}
                    </DialogTitle>
                    <div className="flex items-center text-muted-foreground mb-2">
                      <MapPin className="w-4 h-4 mr-2" />
                      <span className="text-base">{space.location}</span>
                    </div>
              ...
              <div className="flex items-center mb-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-base font-semibold">4.{Math.floor(Math.random() * 5) + 5}</span>
                      ...
                      <div className="flex items-center mr-2">
                        ...
                        <amenity.icon
                          className={`w-3 h-3 ml-1 ${
                            amenity.available ? "text-green-600 dark:text-green-400" : "text-gray-400"
                          }`}
                        />
                      </div>
                      <div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <span>booking@whattaplace.com</span>
                  </div>
                </div>
              </div>
            </div>

            {/* Right side - Map and Booking */}
            <div className="lg:col-span-3 bg-gray-50 dark:bg-gray-900 border-l border-border overflow-y-auto">
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <form onSubmit={handleBookingSubmit} className="space-y-3">
                    ...
                    <Button
                      type="submit"
                      className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white text-sm h-8"
